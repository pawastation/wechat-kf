...
export const wechatKfPlugin: ChannelPlugin<ResolvedWechatKfAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "",
      "**Link Card**: `[[wechat_link: Title | Description | https://url | thumb]]`",
      "  title + url required; desc + thumbnail optional. Thumbnail can be a media_id, local file path, or image URL (auto-uploaded).",
      "  Without a valid thumbnail, falls back to plain-text link.",
      "",
      ...
      "",
      "**Mini Program**: `[[wechat_miniprogram: appid | Title | pages/path | thumb]]`",
      "  appid + title + pagepath required; thumbnail optional but recommended. Thumbnail = media_id, local file path, or image URL (auto-uploaded).",
      "  Without a valid thumbnail, falls back to plain text.",
      "",
